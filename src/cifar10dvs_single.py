...
def main():
    ...
    parser.add_argument('-data-dir', type=str, help='root dir of CIFAR10DVS dataset')
    ...
    net = parametric_lif_net.CIFAR10DVSNet(
    ...
    out_dir = os.path.join(args.out_dir, f'CIFAR10DVSSingle-T{args.T}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}')
