...
def main():
    ...
    net = CIFAR10DVSNet(
        num_outputs=[task_1_number_classes, task_2_number_classes, task_3_number_classes],
    ...
    out_dir = os.path.join(args.out_dir, f'CIFAR10DVSMulti3-T{args.T}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}_loss{args.loss_rate}')
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for frame, label in train_data_loader:
            ...
            if scaler is not None:
                with amp.autocast():
                    ...
                    loss = (1-args.loss_rate)*loss_1 + args.loss_rate/2*loss_2 + args.loss_rate/2*loss_3
        ...
        if ((epoch % 10) == 0) or (epoch == (args.epochs - 1)):
            ...
            print('train_3: %0.4f, ' % train_acc_3, end='')

            print('test_1: %0.4f, ' % test_acc_1, end='')
            print('test_2: %0.4f, ' % test_acc_2, end='')
            print('test_3: %0.4f, ' % test_acc_3, end='')
