...
def main():
    ...
    net = CIFAR10DVSNet(
        num_outputs=[task_1_number_classes, task_2_number_classes, task_3_number_classes, task_4_number_classes],
    ...
    out_dir = os.path.join(args.out_dir, f'CIFAR10DVSMulti5-T{args.T}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}_loss{args.loss_rate}')
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for frame, label in train_data_loader:
            ...
            if scaler is not None:
                with amp.autocast():
                    predicted_output_1, predicted_output_2, predicted_output_3, predicted_output_4 = net(frame)
                    ...
                    loss = (1-args.loss_rate)*loss_1 + args.loss_rate*(loss_2 + loss_3 + loss_4)/3
                scaler.scale(loss).backward()
                scaler.step(optimizer)
                scaler.update()
            else:
                predicted_output_1, predicted_output_2, predicted_output_3 = net(frame)
                predicted_output_1 = predicted_output_1.mean(0)
                predicted_output_2 = predicted_output_2.mean(0)
                predicted_output_3 = predicted_output_3.mean(0)
                predicted_output_4 = predicted_output_4.mean(0)
        ...
        writer.add_scalar('test_acc_4', test_acc_4, epoch)
        ...
        if ((epoch % 10) == 0) or (epoch == (args.epochs - 1)):
            ...
            print('train: %0.4f, %0.4f, %0.4f, %0.4f | ' % (train_acc_1, train_acc_2, train_acc_3, train_acc_4), end='')

            print('test: %0.4f, %0.4f, %0.4f, %0.4f | ' % (test_acc_1, test_acc_2, test_acc_3, test_acc_4), end='')
